	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			category1 : {
				name : 'אנשים שחורים', //Will appear in the data and in the default feedback message.
				title : {
					media : {word : 'אנשים שחורים'}, //Name of the category presented in the task.
			...
			category2 :	{
				name : 'אנשים לבנים', //Will appear in the data and in the default feedback message.
				title : {
					media : {word : 'אנשים לבנים'}, //Name of the category presented in the task.
					css : {color:'#336600','font-size':'1.8em'}, //Style of the category title.
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
			...
			remindErrorText : '<p align="center" style="font-size:0.6em; font-family:arial; color:#000000">' +
				'אם אתה עושה טעות, יופיע <font color = "#ff0000"> <b> X </b> </font> אדום. ' +
				'לחץ על המקש השני כדי להמשיך. <P/>',


			remindErrorTextTouch : '<p align="center" style="font-size:1.4em; font-family:arial; color:#000000">' +
				'אם אתה עושה טעות, יופיע <font color = "#ff0000"> <b> X </b> </font> אדום. ' +
				'גע בצד השני כדי להמשיך. <P/>',
			...
			finalTouchText : 'גע באזור הירוק התחתון כדי להמשיך למשימה הבאה ',
			...
			instAttributePractice: '<div style="font-size:20px; text-align:center;">' +
				...
				'</div>',
//החלק הזה מיועד לממשק הכולל מגע ולכן לא תורגם
